  ...
  return (
    <div className="w-64 absolute md:relative bg-gray-800 shadow h-screen flex-col justify-between hidden md:flex pb-12">
      <div className="px-8">
        ...
        <ul className="mt-7">
          <li className="SidebarButton mb-6">
            <Link
              to="/home"
              className="flex items-center bg-gray-800 focus:text-gray-300 focus:outline-none"
            >
              <svg
          ...
          <li className="flex w-full justify-between text-gray-500 cursor-pointer items-center focus:outline-none">
            <button
              className="flex items-center focus:outline-none dark:bg bg-gray-800 focus:text-gray-300 dark:text-gray-100"
              type="button"
              ref={btnDropdownRef}
              onClick={() => {
                dropdownPopoverShow
            ...
            >
              ...
              <span className="text-sm ml-2 dark:text-gray-200">
                Controlling Options
              </span>
            </button>
            <div
            ...
            >
              <ul>
                <li>
                  <Link
                    to="/webcam"
                    className="flex py-2 px-7 hover:text-gray-300 dark:text-gray-200 items-center bg-gray-800 focus:outline-none"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={15}
                ...
                <li>
                  <Link
                    to="/speech"
                    className="flex py-2 px-7 hover:text-gray-300  bg-gray-800 dark:text-gray-200 items-center focus:outline-none"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={15}
      ...
      <div className="px-2 border-t border-gray-700">
        <button
          className="SidebarButton  focus:outline-none p-5"
          onClick={() => {
