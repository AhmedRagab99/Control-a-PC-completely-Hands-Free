                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col pt-3 md:pt-8">
                        <div className="flex flex-col pt-4">
                            <div className="flex relative ">
                                ...
                                <input id="username" required aria-required="true" name="username" type="text"
                                    value={inputs.username}
                                    onChange={handleChange} className=" Textinput focus:border" placeholder="Username" />
                            </div>
                        </div>
                        <div className="flex flex-col pt-4">
                            <div className="flex relative ">
                                ...
                                <input id="email" required aria-required="true" name="email" type="email"
                                    value={inputs.email}
                                    onChange={handleChange} className="Textinput focus:border" placeholder="Email" />
                            </div>
                        </div>
                        <div className="flex flex-col pt-4 mb-12">
                            <div className="flex relative ">
                                ...
                                <input id="password" type="password" required
                                    ...
                                    onChange={handleChange} className=" Textinput focus:border " placeholder="Password" />
                            </div>
                        </div>
