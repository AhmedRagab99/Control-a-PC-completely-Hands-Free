                ...
                <div className="px-8">
                    ...
                    <ul className="mt-7">
                        <li className="SidebarButton mb-6">
                            <Link to = '/home' className="flex items-center bg-gray-800 focus:text-gray-300 focus:outline-none">
                        ...
                        <li className="SidebarButton mb-6">
                            <Link to = '/configuration' className="flex items-center bg-gray-800 focus:text-gray-300 focus:outline-none">
                        ...
                        <li className="flex w-full justify-between text-gray-500 cursor-pointer items-center focus:outline-none">
                            <button className="flex items-center focus:outline-none dark:bg bg-gray-800 focus:text-gray-300 dark:text-gray-100" type="button"
                                ref={btnDropdownRef}
                                onClick={() => {
                                    dropdownPopoverShow
                                ...
                                <span className="text-sm ml-2 dark:text-gray-200">Controlling Options</span>


                            </button>
                            <div ref={popoverDropdownRef} className={
                                (dropdownPopoverShow ? "block " : "hidden ") +
                                "text-base z-50 float-left bg-gray-800 py-2 list-none text-left dark:text-gray-200 rounded shadow-md mt-1"
                            }
                            >
                                <ul>
                                    <li>
                                        <Link to = '/webcam' className="flex py-2 px-7 hover:text-gray-300 dark:text-gray-200 items-center bg-gray-800 focus:outline-none">
                                    ...
                                    <li>
                                        <Link to='/speech' className="flex py-2 px-7 hover:text-gray-300  bg-gray-800 dark:text-gray-200 items-center focus:outline-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={15} height={15} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
